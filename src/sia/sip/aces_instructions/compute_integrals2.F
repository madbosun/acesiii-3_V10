...
C  in the file COPYRIGHT.
      subroutine compute_integrals2(a1,a2,b1,b2,c1,c2,d1,d2,scr,
...
c---------------------------------------------------------------------------
     ...
     *          nints .gt. 0) then
            ...
            if (jx .eq. 1) then 
               call scf_tp2(nc1,nc2,nd1,nd2,ca, a1,a2,b1,b2,c1,c2,d1,d2,
     *                             scr(nfirst), 
     *                             aa1,aa2,bb1,bb2,cc1,cc2,dd1,dd2,
     *                             Fa)
            else 
               call scf_tp2a(nc1,nc2,nd1,nd2,ca,a1,a2,b1,b2,c1,c2,d1,d2,
     *                             scr(nfirst), 
     *                             aa1,aa2,bb1,bb2,cc1,cc2,dd1,dd2,
     *                             Fa)
            endif 
...
c ------------------------------------------------------------------- 
c 
      subroutine scf_tp2(nc1,nc2,nd1,nd2,ca,va1,va2,vb1,vb2,vc1,vc2,
...
c ------------------------------------------------------------------- 
c 
      subroutine scf_tp2a(nc1,nc2,nd1,nd2,ca,va1,va2,vb1,vb2,vc1,vc2,
     &                vd1,vd2,intblk, a1, a2, b1, b2, c1, c2, d1, d2,
     &                Fa)
      implicit none
      include 'int_gen_parms.h'
      ...
      double precision Fa(nc1:nc2,nc1:nc2)
      double precision intblk(a1:a2,b1:b2,c1:c2,d1:d2)
      double precision dtemp, dcrit, factor   
      ...
      factor = 4.0
      itype  = 1
      call fdmult1b(arange1,arange2,brange1,brange2,
