...
C  in the file COPYRIGHT.
      subroutine compute_integrals5(a1,a2,b1,b2,c1,c2,d1,d2,scr,
...
c---------------------------------------------------------------------------
     ...
     *          nints .gt. 0) then
            ...
            if (jx .eq. 1) then 
               call scf_tp5(nc1,nc2,nd1,nd2,ca, a1,a2,b1,b2,c1,c2,d1,d2,
     *                             scr(nfirst), 
     *                             aa1,aa2,bb1,bb2,cc1,cc2,dd1,dd2,
     *                             Fa)
            else 
               call scf_tp5a(nc1,nc2,nd1,nd2,ca,a1,a2,b1,b2,c1,c2,d1,d2,
     *                             scr(nfirst), 
     *                             aa1,aa2,bb1,bb2,cc1,cc2,dd1,dd2,
     *                             Fa)
            endif 
...
c ------------------------------------------------------------------- 
c 
      subroutine scf_tp5(nc1,nc2,nd1,nd2,ca,va1,va2,vb1,vb2,vc1,vc2,
...
c ------------------------------------------------------------------- 
c 
      subroutine scf_tp5a(nc1,nc2,nd1,nd2,ca,va1,va2,vb1,vb2,vc1,vc2,
     &                vd1,vd2,intblk, a1, a2, b1, b2, c1, c2, d1, d2,
     &                Fa)
      implicit none
      include 'int_gen_parms.h'
