...
C  in the file COPYRIGHT.
      subroutine compute_uintegrals1(a1,a2,b1,b2,c1,c2,d1,d2,scr,
...
c---------------------------------------------------------------------------
           ...
           if (nints .gt. 0) then
            ...
            if (jx .eq. 1) then 
              ...
              call uscf_tp1(nc1,nc2,nd1,nd2,ca,cb,a1,a2,b1,b2,
     *                             c1,c2,d1,d2,
     *                             scr(nfirst), 
     ...
     *                             Fa,Fb)
              ...
              call uscf_tp1a(nc1,nc2,nd1,nd2,ca,cb,a1,a2,b1,b2,
     *                             c1,c2,d1,d2,
     *                             scr(nfirst), 
     *                             aa1,aa2,bb1,bb2,cc1,cc2,dd1,dd2,
     *                             Fa,Fb)
...
c ------------------------------------------------------------------- 
c 
      subroutine uscf_tp1a(nc1,nc2,nd1,nd2,xa,xb,va1,va2,vb1,vb2,
     &                vc1,vc2,
...
c
      subroutine uscf_tp1(nc1,nc2,nd1,nd2,ca,cb,va1,va2,vb1,vb2,
     &                vc1,vc2,
     &                vd1,vd2,intblk, a1, a2, b1, b2, c1, c2, d1, d2,
     &                Fa,Fb)
      implicit none
