...
C  in the file COPYRIGHT.
      subroutine compute_uintegrals2(a1,a2,b1,b2,c1,c2,d1,d2,scr,
...
c---------------------------------------------------------------------------
     ...
     *         nints .gt. 0) then
              ...
              call uscf_tp2(nc1,nc2,nd1,nd2,ca,cb,a1,a2,b1,b2,
     *                             c1,c2,d1,d2,
     *                             scr(nfirst), 
     ...
     *                             Fa,Fb)
              ...
              call uscf_tp2a(nc1,nc2,nd1,nd2,ca,cb,a1,a2,b1,b2,
     *                             c1,c2,d1,d2,
     *                             scr(nfirst), 
     *                             aa1,aa2,bb1,bb2,cc1,cc2,dd1,dd2,
     *                             Fa,Fb)
...
c ------------------------------------------------------------------- 
c 
      subroutine uscf_tp2a(nc1,nc2,nd1,nd2,xa,xb,va1,va2,vb1,vb2,
     &                vc1,vc2,
...
c ------------------------------------------------------------------- 
c 
      subroutine uscf_tp2(nc1,nc2,nd1,nd2,ca,cb,va1,va2,vb1,vb2,
     &                vc1,vc2,
     &                vd1,vd2,intblk, a1, a2, b1, b2, c1, c2, d1, d2,
     &                Fa,Fb)
      implicit none
...
33       continue  
               ...
               ftemp_cd  = ftemp_cd + cab(a+ainc,b)*itemp ! etemp1 
               ftempa_ad = ca_bc*itemp ! etemp3 
               ftempb_ad = cb_bc*itemp ! etemp5 
               ftempa_ac = ca_bd*itemp ! etemp2 
               ftempb_ac = cb_bd*itemp ! etemp4 
