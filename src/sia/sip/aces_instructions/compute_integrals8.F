...
C  in the file COPYRIGHT.
      subroutine compute_integrals8(a1,a2,b1,b2,c1,c2,d1,d2,scr,
...
c---------------------------------------------------------------------------
     ...
     *          nints .gt. 0) then
             ...
             if (jx .eq. 1) then 
               call scf_tp8(nc1,nc2,nd1,nd2,ca, a1,a2,b1,b2,c1,c2,d1,d2,
     *                             scr(nfirst), 
     *                             aa1,aa2,bb1,bb2,cc1,cc2,dd1,dd2,
     *                             Fa)
             else 
               call scf_tp8a(nc1,nc2,nd1,nd2,ca,a1,a2,b1,b2,c1,c2,d1,d2,
     *                             scr(nfirst), 
     *                             aa1,aa2,bb1,bb2,cc1,cc2,dd1,dd2,
     *                             Fa)
             endif 
...
c ------------------------------------------------------------------- 
c 
      subroutine scf_tp8(nc1,nc2,nd1,nd2,ca,va1,va2,vb1,vb2,vc1,vc2,
...
c ------------------------------------------------------------------- 
c 
      subroutine scf_tp8a(nc1,nc2,nd1,nd2,ca,va1,va2,vb1,vb2,vc1,vc2,
     &                vd1,vd2,intblk, a1, a2, b1, b2, c1, c2, d1, d2,
     &                Fa)
      implicit none
      include 'int_gen_parms.h'
      ...
      double precision Fa(nc1:nc2,nc1:nc2)
      double precision intblk(a1:a2,b1:b2,c1:c2,d1:d2)
      double precision dtemp, etemp, factor, dcrit    
     ...
     *              sym,nc1,nc2,nd1,nd2,ca,fa,dcrit,itype) 
      ...
      itype  = 3
      factor =-1.0
      call fdmult1b(arange1,arange2,crange1,crange2,
     ...
     *              sym,nc1,nc2,nd1,nd2,ca,fa,dcrit,itype) 
      ...
      itype = 4
      factor =-1.0
      call fdmult1b(arange1,arange2,drange1,drange2,
     *              crange1,crange2,brange1,brange2,
     *              a1,a2,b1,b2,c1,c2,d1,d2,intblk,factor,
     *              sym,nc1,nc2,nd1,nd2,ca,fa,dcrit,itype) 

c     VFL 
c For some reason I CANNOT get this call to work so it is done below!
c     itype = 5
c     factor =-1.0
c     call fdmult1b(crange1,crange2,brange1,brange2,
c    *              arange1,arange2,drange1,drange2,
c    *              a1,a2,b1,b2,c1,c2,d1,d2,intblk,factor,
c    *              sym,nc1,nc2,nd1,nd2,ca,fa,dcrit,itype)

      itype = 6
      factor =-1.0
      call fdmult1b(brange1,brange2,drange1,drange2,
