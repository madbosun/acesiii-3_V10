         SUBROUTINE  ERD__SOI_PCGTO_BLOCK_YX
     +
     +                    ( NBATCH,
...
cSSS         write(*,*) 'ATOMAB=',ATOMAB
cSSS         write(*,*) 'ATOMCD=',ATOMCD
...
C
C
c         write(*,*) 'CASEAT=',CASEAT
c         write(*,*) 'CASEAT has to be 4'
         IF (CASEAT.EQ.4) THEN
...
c        write(*,*) ' I think I need to differential A and B'
c        write(*,*) 'DIFFA=',DIFFA
c        write(*,*) 'DIFFB=',DIFFB
...
c          write(*,*) 'this is where I need to be'
C
C
...
C
C
c             write(*,*) 'what is shellT'
c             write(*,*) 'shellt=',shellt
             IF (SHELLT.GT.0 .OR. DIFFY) THEN
