         SUBROUTINE  OED__SOI_3CEN_PCGTO_BLOCKxy
     +
     +                    ( NBATCH,
...
CSSS       WRITE (*,'(A,3(1x,I3))') 'DERAX,DERAY,DERAZ = ',DERAX,DERAY,DERAZ
CSSS       WRITE (*,'(A,3(1x,I3))') 'DERBX,DERBY,DERBZ = ',DERBX,DERBY,DERBZ
CSSS       WRITE (*,'(A,3(1x,I3))') 'DERCX,DERCY,DERCZ = ',DERCX,DERCY,DERCZ
         IF (DIFFX) THEN
...
C
C             ...if  perform differentiation (if any) of
C                the 1DX AB integrals on the remaining shell center B.
C
C
c   DIFFB is false for my case so I will be OK, Prakash
c............................................................................
         ELSE
             CALL    OED__NAI_1D_AB_INTEGRALS
     +
