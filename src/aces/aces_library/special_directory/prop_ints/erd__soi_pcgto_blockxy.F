         SUBROUTINE  ERD__SOI_PCGTO_BLOCKXY
     +
     +                    ( NBATCH,
...
C
        ...
        write(*,*) ' I think I need to differential A and B'
...
C
C
         write(*,*) 'Primtype must be ABCD'
         write(*,*) 'PRIMTYP=',PRIMTYP
  ...
  534                CONTINUE
     ...
     +
         ...
         ELSE IF (PRIMTYP .EQ. 'ABCD') THEN
          write(*,*) 'this is where I need to be'
C
C
...
C
     ...
     +
             IF (DIFFX) THEN
                 ...
                 DER3 = DERCX
                 DER4 = DERDX
              write(*,*) ' tell me about DER'
              write(*,'(4(1x,I3))') DER1, DER2,DER3,DER4
              write(*,*) 'tlee me about NDERX',NDERX
                 DO 600 N = 1,NDERX
  ...
  605               CONTINUE
            ...
            write(*,*) 'what is this centre=',center

cPV                    DEROP1 = CENEQS (1,CENTER)
cPV                    DEROP2 = CENEQS (2,CENTER)
cPV                    DEROP3 = CENEQS (3,CENTER)
cPV                    DEROP4 = CENEQS (4,CENTER)
