...
c      WRITE (*,'(A,4(1x,I3))')'In A,B,C,D =',INDEXA,INDEXB,INDEXC,INDEXD
c      WRITE (*,*) ' EQUALAB,EQUALCD = ',EQUALAB,EQUALCD
c      WRITE (*,'(A,3(1x,F15.5))') ' XA,YA,ZA = ',XA,YA,ZA
c      WRITE (*,'(A,3(1x,F15.5))') ' XB,YB,ZB = ',XB,YB,ZB
c      WRITE (*,'(A,3(1x,F15.5))') ' XC,YC,ZC = ',XC,YC,ZC
c      WRITE (*,'(A,3(1x,F15.5))') ' XD,YD,ZD = ',XD,YD,ZD
c      WRITE (*,*) ' SWAPRS,SWAPTU = ',SWAPRS,SWAPTU
c      WRITE (*,'(A,3(1x,F15.5))') ' ABX,ABY,ABZ = ',ABX,ABY,ABZ
c      WRITE (*,'(A,3(1x,F15.5))') ' CDX,CDY,CDZ = ',CDX,CDY,CDZ
c      WRITE (*,'(A,2(1x,F15.5))') ' RNABSQ,RNCDSQ = ',RNABSQ,RNCDSQ
c      WRITE (*,'(A,3(1x,I3))')'NDERX,NDERY,NDERZ = ',NDERX,NDERY,NDERZ
c      WRITE (*,'(A,3(1x,I3))')'DERAX,DERAY,DERAZ = ',DERAX,DERAY,DERAZ
c      WRITE (*,'(A,3(1x,I3))')'DERBX,DERBY,DERBZ = ',DERBX,DERBY,DERBZ
c      WRITE (*,'(A,3(1x,I3))')'DERCX,DERCY,DERCZ = ',DERCX,DERCY,DERCZ
c      WRITE (*,'(A,3(1x,I3))')'DERDX,DERDY,DERDZ = ',DERDX,DERDY,DERDZ
c      WRITE (*,*) ' PRIMTYP = ',PRIMTYP
c      WRITE (*,*) ' ANGMTYP = ',ANGMTYP
c      WRITE (*,'(A,4(1x,I3))') ' CENEQS = ',(CENEQS(1,I),I=1,4)
c      WRITE (*,'(A,4(1x,I3))') ' CENEQS = ',(CENEQS(2,I),I=1,4)
c      WRITE (*,'(A,4(1x,I3))') ' CENEQS = ',(CENEQS(3,I),I=1,4)
c      WRITE (*,'(A,4(1x,I3))') ' CENEQS = ',(CENEQS(4,I),I=1,4)
...
C
         ...
         DO 1000 NIJBEG = 1,NIJ,NIJBLK
            ...
            DO 1100 NKLBEG = 1,NKL,NKLBLK
               ...
               MIJKL = MIJ * MKL
                MGQIJKL = NGQP * MIJKL
c            write(*,*) NIJbeg,NKLbeg
               CALL  ERD__SOI_PCGTO_BLOCK_YX
     +
     +                    ( NBATCH,
     +                      NINT2DX,NINT2DY,NINT2DZ,
     +                      ATOMAB,ATOMCD,
