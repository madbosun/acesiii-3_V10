...
c        write(*,*) 'NGQP=',NGQP
c        write(*,*) 'SHellp=',shellp
c        write(*,*) 'NDERX=',NDERX
c        write(*,*) 'NDERY=',NDERY,NDERZ
...
c          write(*,*)
             DO 3000 NIJBEG = 1,NIJ,NIJBLK
                ...
                MIJCEN  = MIJ * NCENC
                MGIJCEN = NGQP * MIJCEN
c           write(*,*) 'NIJBEFg=',NIJBEG
c           write(*,*)'NIJEND',NIJEND
c           write(*,*)'MIJ=',MIJ
c           write(*,*)'MIJCEN=',MIJCEN
c           write(*,*)'MGIJCEN=',MGIJCEN 
c      write(*,*) 'Zscale=',zscale
                CALL  OED__SOI_3CEN_PCGTO_BLOCKyx
     +
     +                     ( NBATCH,
     +                       NINT1DX,NINT1DY,NINT1DZ,
     +                       ATOMIC,
